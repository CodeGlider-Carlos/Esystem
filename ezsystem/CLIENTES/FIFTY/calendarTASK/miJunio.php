            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'JUNIO'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'JUNIO'.$lunes;
                                $idverMA = 'JUNIO'.$martes;
                                $idverMI = 'JUNIO'.$miercoles;
                                $idverJ = 'JUNIO'.$jueves;
                                $idverV = 'JUNIO'.$viernes;
                                $idverS = 'JUNIO'.$sabado;
                                $idverD = 'JUNIO'.$domingo;
