            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'MARZO'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'MARZO'.$lunes;
                                $idverMA = 'MARZO'.$martes;
                                $idverMI = 'MARZO'.$miercoles;
                                $idverJ = 'MARZO'.$jueves;
                                $idverV = 'MARZO'.$viernes;
                                $idverS = 'MARZO'.$sabado;
                                $idverD = 'MARZO'.$domingo;
                                                    ...
                                                    if($alltask1 > 0){
                                                        ...
                                                        if(empty($lunes)){
                                                            ...
                                                            <form   method="POST" action="#">
                                                                ...
                                                                <input hidden  type="text"   value="<?php echo $mesnum.'userUnidad'.$userUnidad;?>" name="mesnum" >
