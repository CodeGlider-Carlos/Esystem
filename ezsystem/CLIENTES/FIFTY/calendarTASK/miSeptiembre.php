            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'SEPTIEMBRE'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'SEPTIEMBRE'.$lunes;
                                $idverMA = 'SEPTIEMBRE'.$martes;
                                $idverMI = 'SEPTIEMBRE'.$miercoles;
                                $idverJ = 'SEPTIEMBRE'.$jueves;
                                $idverV = 'SEPTIEMBRE'.$viernes;
                                $idverS = 'SEPTIEMBRE'.$sabado;
                                $idverD = 'SEPTIEMBRE'.$domingo;
