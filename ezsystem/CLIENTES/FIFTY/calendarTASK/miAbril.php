            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'ABRIL'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'ABRIL'.$lunes;
                                $idverMA = 'ABRIL'.$martes;
                                $idverMI = 'ABRIL'.$miercoles;
                                $idverJ = 'ABRIL'.$jueves;
                                $idverV = 'ABRIL'.$viernes;
                                $idverS = 'ABRIL'.$sabado;
                                $idverD = 'ABRIL'.$domingo;
