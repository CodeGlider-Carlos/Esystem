                ...
                <div id="tabenero" class="backtabla"  method="POST" action="#">
                    ...
                    <table id="tablata">
                        ...
                        <?php
                                ...
                                $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'FEBRERO'  ";
                                ...
                                while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                    ...
                                    $idverL = 'FEBRERO'.$lunes;
                                    $idverMA = 'FEBRERO'.$martes;
                                    $idverMI = 'FEBRERO'.$miercoles;
                                    $idverJ = 'FEBRERO'.$jueves;
                                    $idverV = 'FEBRERO'.$viernes;
                                    $idverS = 'FEBRERO'.$sabado;
                                    $idverD = 'FEBRERO'.$domingo;
                                                        ...
                                                        if($alltask1 > 0){
                                                            ...
                                                            if(empty($lunes)){
                                                                ...
                                                                <form   method="POST" action="#">
                                                                    ...
                                                                    <input type="submit"   class="tottareas" value="<?php echo $alltask1.' T';?>" name="subverEvent" >
                                                    ...
                                                    <?php
                                                        if($alltask2 > 0){
                                                            ...
                                                            if(empty($martes)){
                                                                ...
                                                                <form   method="POST" action="#">
                                                                    <input type="submit"   class="tottareas" value="<?php echo $alltask2.' T';?>" name="subverEvent" >
                                                        ...
                                                        if($alltask3 > 0){
                                                            ...
                                                            if(empty($miercoles)){
                                                                ...
                                                                <form   method="POST" action="#">
                                                                    ...
                                                                    <input type="submit"   class="tottareas" value="<?php echo $alltask3.'T';?>" name="subverEvent" >
                                                    ...
                                                    <?php
                                                        if($alltask4 > 0){
                                                            ...
                                                            if(empty($jueves)){
                                                                ...
                                                                ?>
                                                                <form   method="POST" action="#">
                                                                    <input type="submit"   class="tottareas" value="<?php echo $alltask4.'T';?>" name="subverEvent" >
                                                        ...
                                                        if($alltask5 > 0){
                                                            ...
                                                            if(empty($viernes)){
                                                                ...
                                                                <form   method="POST" action="#">
                                                                        ...
                                                                        <input type="submit"   class="tottareas" value="<?php echo $alltask5.'T';?>" name="subverEvent" >
                                                        ...
                                                        <?php
                                                            if($alltask6 > 0){
                                                                ...
                                                                if(empty($sabado)){
                                                                    ...
                                                                    <form   method="POST" action="#">
                                                                        <input type="submit"   class="tottareas" value="<?php echo $alltask6.'T';?>" name="subverEvent" >
                                                        ...
                                                        if($alltask7 > 0){
                                                            ...
                                                            if(empty($domingo)){
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <form   method="POST" action="#">
                                                                        <input type="submit"   class="tottareas" value="<?php echo $alltask7.'T';?>" name="subverEvent" >
