            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'OCTUBRE'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'OCTUBRE'.$lunes;
                                $idverMA = 'OCTUBRE'.$martes;
                                $idverMI = 'OCTUBRE'.$miercoles;
                                $idverJ = 'OCTUBRE'.$jueves;
                                $idverV = 'OCTUBRE'.$viernes;
                                $idverS = 'OCTUBRE'.$sabado;
                                $idverD = 'OCTUBRE'.$domingo;
