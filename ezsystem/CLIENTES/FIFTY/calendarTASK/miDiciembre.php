            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'DICIEMBRE'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'DICIEMBRE'.$lunes;
                                $idverMA = 'DICIEMBRE'.$martes;
                                $idverMI = 'DICIEMBRE'.$miercoles;
                                $idverJ = 'DICIEMBRE'.$jueves;
                                $idverV = 'DICIEMBRE'.$viernes;
                                $idverS = 'DICIEMBRE'.$sabado;
                                $idverD = 'DICIEMBRE'.$domingo;
