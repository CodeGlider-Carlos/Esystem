            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'NOVIEMBRE'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'NOVIEMBRE'.$lunes;
                                $idverMA = 'NOVIEMBRE'.$martes;
                                $idverMI = 'NOVIEMBRE'.$miercoles;
                                $idverJ = 'NOVIEMBRE'.$jueves;
                                $idverV = 'NOVIEMBRE'.$viernes;
                                $idverS = 'NOVIEMBRE'.$sabado;
                                $idverD = 'NOVIEMBRE'.$domingo;
