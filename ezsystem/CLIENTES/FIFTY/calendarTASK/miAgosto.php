            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'AGOSTO'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'AGOSTO'.$lunes;
                                $idverMA = 'AGOSTO'.$martes;
                                $idverMI = 'AGOSTO'.$miercoles;
                                $idverJ = 'AGOSTO'.$jueves;
                                $idverV = 'AGOSTO'.$viernes;
                                $idverS = 'AGOSTO'.$sabado;
                                $idverD = 'AGOSTO'.$domingo;
