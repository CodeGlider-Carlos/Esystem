            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'JULIO'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'JULIO'.$lunes;
                                $idverMA = 'JULIO'.$martes;
                                $idverMI = 'JULIO'.$miercoles;
                                $idverJ = 'JULIO'.$jueves;
                                $idverV = 'JULIO'.$viernes;
                                $idverS = 'JULIO'.$sabado;
                                $idverD = 'JULIO'.$domingo;
