            ...
            <div id="tabenero" class="backtabla"  method="POST" action="#">
                ...
                <table id="tablata">
                    ...
                    <?php
                            ...
                            $tabdiamy = "SELECT * FROM $diaesyear WHERE year LIKE '%$yearHoy%'  AND mes = 'ENERO'  ";
                            ...
                            while ($tabcal = $qtabdiamy->fetch(PDO::FETCH_ASSOC))  {
                                ...
                                $idverL = 'ENERO'.$lunes;
                                $idverMA = 'ENERO'.$martes;
                                $idverMI = 'ENERO'.$miercoles;
                                $idverJ = 'ENERO'.$jueves;
                                $idverV = 'ENERO'.$viernes;
                                $idverS = 'ENERO'.$sabado;
                                $idverD = 'ENERO'.$domingo;
