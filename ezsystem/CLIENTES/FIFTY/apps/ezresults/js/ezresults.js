...
$(document).ready(function () {
    ...
    $("#boton_riel1").click(function () {
        $('#mod_indica').css('display', 'block')
        $('#mod_estado').css('display', 'none')
        $('#mod_estrat').css('display', 'none')
        $('#mod_flujo').css('display', 'none')
        $('#mod_prod').css('display', 'none')
    });

    $("#boton_riel2").click(function () {
        $('#mod_indica').css('display', 'none')
        $('#mod_estado').css('display', 'block')
        $('#mod_estrat').css('display', 'none')
        $('#mod_flujo').css('display', 'none')
        $('#mod_prod').css('display', 'none')
    });
