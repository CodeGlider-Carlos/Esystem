                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if($cumple ==  NULL){
                                                                            ...
                                                                            if($cumple >= $minguind & $cumple <= $maxguind){
                                                                                ?><div class="blacky"><?php  echo number_format($cumple, 2) . '%';  ?></div><?php                               
                                                                            }elseif($cumple >= $minred & $cumple <= $maxred){
                                                                                ?><div class="redy"><?php  echo number_format($cumple, 2) . '%';  ?></div><?php                   
                                                                            }elseif($cumple >= $minyell & $cumple <= $maxyell){
                                                                                ?><div class="yelly"><?php  echo number_format($cumple, 2) . '%';  ?></div><?php
                                                                                                         
                                                                            }elseif($cumple >= $mingreen & $cumple <= $maxgreen){
                                                                                ?><div class="green"><?php  echo number_format($cumple, 2) . '%';  ?></div><?php
                                                                                                          
                                                                            }elseif($cumple >= $minblu){
                                                                                ?><div class="bluey"><?php  echo number_format($cumple, 2) . '%';  ?></div><?php
