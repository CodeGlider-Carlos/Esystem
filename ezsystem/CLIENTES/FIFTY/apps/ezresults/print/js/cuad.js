...
$(document).ready(function () {
    ...
    ///////////////////////////////////////
    $('.posiof').mouseover(function () {
        setTimeout(() => {
            $('.posiobtextf').css('display', 'block')
        }, 0)
    });
    $('.posiof').mouseout(function () {
        setTimeout(() => {
            $('.posiobtextf').css('display', 'none')
        }, 0)
    });

  
    ///////////////////////////////////////
    $('#posiop').mouseover(function () {
        setTimeout(() => {
            $('#posiobtextp').css('display', 'block')
        }, 0)
    });
    $('#posiop').mouseout(function () {
        setTimeout(() => {
            $('#posiobtextp').css('display', 'none')
        }, 0)
    });
