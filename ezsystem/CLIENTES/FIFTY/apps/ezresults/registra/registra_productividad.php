...
<body>
    ...
    <section id="backallres">
          ...
          <form id="plnCOm" method="POST" action="save_produ.php" autocomplete="off">
            ...
            <input hidden type="text" value="<?php echo $tabunidad ;?>" name="unidad">
                ...
                <div id="conttabobj">
                    ...
                    <table id="tablataobj">
                        ...
                        <tr>
                            <th colspan="5" class="nameReg">PRODUCTIVIDAD</th>
                        </tr>

                        <tr id="columnasob">
                            
                            <th  class="col1ES">MES</th>
                            <th  class="col2ES">RESULTADO</th> 
                        ...
                        <?php
                                    ...
                                    $tabesta = "SELECT * FROM $product WHERE yearco LIKE '%$year%' AND activo = 'SI' AND unidad LIKE '%$tabunidad%'  ";
                                    ...
                                    while ($fila = $qtabesta->fetch(PDO::FETCH_ASSOC)) { 
                                        ...
                                        echo '
                                            ...
                                            <tr>
                                                ...
                                                <td> <input type="number" step="0.01" name="resultado[' . $fila['id'] . ']" class="selectREg focus center"  placeholder="ESCRIBE SIN SIMBOLOS..."  > </td>
                                            

                                               <td ><input type="text" id=mes  value="'. $prinrMESnum . '" class="selectREg" readonly></td>  
                                              

                                                <td  ><textarea  class="selectREg marginleft focus" placeholder="'. $printObser .'" readonly></textarea></td>
