                ...
                <?php 
                    ...
                    foreach ($_POST['idUpdate'] as $idUpdate) {
                        ...
                        if(empty($resultad)){
                            ...
                            $inresl = "UPDATE $produciv SET $colev  ='$resultad' WHERE id='$idUpdate'";
                            ...
                            $valyidm2 = "SELECT * FROM $produciv WHERE  id = '$idUpdate' ";
                        ...
                        if(empty($resultad)){
                                ...
                                $inresl2 = "UPDATE $produciv SET acumulado  ='$acumulado' WHERE id='$idUpdate'";
                        ...
                        if(!empty($obs)){
                            ...
                            $obsesav = "UPDATE $produciv SET $coloBS  ='$qobs' WHERE id='$idUpdate'";
