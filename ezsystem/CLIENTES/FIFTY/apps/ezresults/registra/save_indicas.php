            ...
            <input hidden type="text" value="<?php echo $unidad; ?>" name="unidad">
                ...
                <?php 
                    ...
                    foreach ($_POST['idUpdate'] as $idUpdate) {
                        ...
                        $valyidm = "SELECT * FROM $tabRes WHERE  idindi = '$idUpdate' ";
                        $qvalyidm = $dbo->query($valyidm);                            
                
                        while($fila = $qvalyidm->fetch(PDO::FETCH_ASSOC)) {
                            $metaP = $fila['meta'];
                            $pondP = $fila['pond'];
                        ...
                        if(!empty($resultad)){
                            ...
                            if($resultad == 'NS' OR $resultad == 'ST' OR $resultad == 'NS' ){
                                ...
                                $desemp = 0;
                                    ...
                                    $mesCumple = $resultado*100/$metaP;
                                    $desemp = $mesCumple*$pondP/100;
                            ...
                            $inresl = "UPDATE $tabRes SET $colev  ='$resultado' WHERE idindi='$idUpdate'";
                            $qinresl = $dbo->query($inresl);

                            $inresl = "UPDATE $tabRes SET cumple  ='$mesCumple' WHERE idindi='$idUpdate'";
                            $qinresl = $dbo->query($inresl);


                            $inresl = "UPDATE $tabRes SET resultado  ='$desemp' WHERE idindi='$idUpdate'";
                            $qinresl = $dbo->query($inresl);
                            ...
                            $valyidm2 = "SELECT * FROM $tabRes WHERE  idindi = '$idUpdate' ";
                            $qvalyidm2 = $dbo->query($valyidm2);                            
                            ...
                            $inresl2 = "UPDATE $tabRes SET acumulado  ='$acumulado' WHERE idindi='$idUpdate'";
                            $qinresl2 = $dbo->query($inresl2);


                            $inresl2 = "UPDATE $tabRes SET promedio  ='$pomedio' WHERE idindi='$idUpdate'";
                            $qinresl2 = $dbo->query($inresl2);
                        ...
                        if(!empty($obs)){
                            ...
                            $obsesav = "UPDATE $tabRes SET $coloBS  ='$qobs' WHERE idindi='$idUpdate'";
                            $qobsesav = $dbo->query($obsesav);
