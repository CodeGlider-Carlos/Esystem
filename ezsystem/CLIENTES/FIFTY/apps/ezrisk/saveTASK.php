...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="RISK/css/risk.css">
        ...
        <?php
            if(isset($_POST['svaeTask'])){
                ...
                $fechahoy = date('Y-m-d');
                    ...
                    $tabsave1 = "INSERT INTO $tabtaskY VALUES (NULL,'$regionNAME','$ucliente','$dirger','$userjefe','$yerfinpro','RISK',NULL,
                    '$fechahoy',NULL,'$userLog','$userLog',NULL,'$tarea','$nombreREsp',
                    '$fechapro','$yerfinpro','$mesfinpro','$diafinpro',NULL,'EN CURSO',
                    NULL,NULL,NULL,NULL,NULL,'$userLog','$userkaskLY','risk','SI',NULL,NULL )";
                ...
                ?>
                    ...
                    <form method="POST" action="indexRisk.php" id="backregresar">
                ...
                if(empty($estatus)){
                    ...
                    if( $estatus == 'CANCELADA'){
                        ...
                        $updestat2 = "UPDATE $tabtaskY SET activo=NULL WHERE id='$idtask' ";
                        $qupdestat2 = $db_task->query($updestat2);
