...
<!-- id="bodyprint" -->
<body >
        <img src="../../../img/logos/50d_icoBlanco.png" class="img_grafa"> 
        <?php
                    ...
                    if($tipo == 'CEDULA' ){
                        ...
                        ?>
                            <section id="backcabePrint" >
                                ...
                                echo 'DESEMPEÑO/'.'IMPRESION: '.$fechahoy.'/'.$year.'/'.$periodo.'/'.$cliente.'/'.$depto.'/'.$trabaj.'/'.  $macro  .  '/' .  $enfoque  .  '/' . $sino.  '/' . $evento;
                                ?>
                            ...
                            <section id="backTablePrint">
                                ...
                                <table class="table" id="tableCed">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="2 id="fallaD">RESULTADOS</th>

                                    </tr>

                                    <tr>
                                        <td colspan="2"><?php echo 'OPORTUNIDADES: '.$totalop;  ?></td>

                                    </tr>
                            
                                    <tr>
                                        <td colspan="2"><?php echo 'FALLAS: '. $casosdefalla;  ?></td>
                                    </tr>

                                    <tr>
                                        <td colspan="2" id="mestra" class="center">
                                            <?php
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2 id="resultado" class="center">
                                                    
                                            <?php
                                                if ($totalop == 0) {
                                                    echo 'NO EVALUADO';
                                                } else {
                                                    echo 'DESEMPEÑO: ' . number_format($resul, 2) . '%' . '<br>';
                                                }
                                            ?>  
                                    ...
                                    <?php
                                            ...
                                            while ($fila = $qtabfall->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                while ($fila = $qbdlyenfoq->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td class="center idREG"><?php echo $idREG;  ?></td>  
                                                            <td class="center enfoqueNAME"><?php echo $enfoqueNAME;  ?></td>  
                                                            <td class="left fallafall"><?php echo $fallafall;  ?></td>                                              
                                                            <td class="center riesg"><?php echo $riesg;  ?></td>
                                                            <td class="center trabajadorNAME"><?php echo $trabajadorNAME;  ?></td>      
                        ...
                        ?>
                            ...
                            <div id="backcabePrint">  <?php
                                ...
                                echo 'OBSERVACIONES POR EVALUADORES/'.'IMPRESION: '.$fechahoy.'/'.$year.'/'.$periodo.'/'.$cliente.  $macro  .  '/' .  $enfoque.'/'.$nombreEV ;
                                ?>
                        ...
                        ?>
                            ...
                            <div id="backcabePrint">  <?php
                                ...
                                echo 'CONSECUENCIAS POR TIPO DE FALLA/'.'IMPRESION: '.$fechahoy.'/'.$year.'/'.$periodo.'/'.$cliente.  $macro  .  '/' .  $enfoque.'/'.$evento;
                                ?>
                        ...
                        ?>                                        
                            ...
                            <div id="backcabePrint">  <?php
                                ...
                                echo 'MATRIZ DE RIESGOS/'.'IMPRESION: '.$fechahoy.'/'.$year.'/'.$periodo.'/'.$cliente.  $macro  .  '/' .  $enfoque ;
                                ?>
