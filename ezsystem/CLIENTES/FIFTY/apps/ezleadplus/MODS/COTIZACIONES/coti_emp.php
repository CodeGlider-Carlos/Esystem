...
<body class="body_ezlead">
    ...
    <modseg  id="modprosp">
                    ...
                    ?>
                        <section id="section1" class="sectionmod">
                            ...
                            <div class="tabcpo" >
                                ...
                                <div for="valor" class="label">Valor Final Estimado</div>
                                <input type="text" id="valor" name="valorfin" class="input" value="<?php echo $Pvalor0;?>" readonly>
                    ...
                    ?>
                        <section id="section1" class="sectionmod">
                            ...
                            <form class="tabcpo" method="POST"  action="saveTRA.php" autocomplete="off" onkeydown="return event.key != 'Enter';" >
                                ...
                                <input hidden type="text" value="<?php echo $Pid0;?>" name="Pid0">
                                <input hidden type="text" value="<?php echo $tipotarj; ?>" name="tipotarj">
                                <input hidden type="text" value="<?php echo $procedimiento; ?>" name="procedimiento">
        ...
        <section id="section2" class="sectionmod">
            ...
            <div class="namesect" id="namesect3">COTIZACION</div>
            ...
            <section id="backnavboton">
                ...
                <section id="backnavbot">
                    ...
                    <div class="backbo">
                        <img id="boto8" src="../../img/suite/coti.png" class="botco">
                        <div class="lineAC" id="lineAC8"></div>
                        <div class="txtbo" id="txtbo8">SIMULACION</div>
                    </div>
            ...
            <div id="backtasky">
                ...
                <div id="backaccionesTR">   
                    ...
                    <form method="POST" action="saveTRA.php" autocomplete="off" onkeydown="return event.key != 'Enter';">
                        ...
                        <input hidden type="text" value="2" name="etapa">
                        <input hidden type="text" value="<?php echo $person;?>" name="person">
                        <input hidden type="text" value="<?php echo $Pid0;?>" name="Pid0">
                        <input hidden type="text" value="<?php echo $tipotarj;?>" name="tipotarj">
                        <table class="tableTASK">
                ...
                <div id="backahistorias">
                        ...
                        <div id="backtab">
                                ...
                                if($adminrol== $radmin ){
                                    $bdpros= "SELECT * FROM $lead_task WHERE tipotarj = '$tipotarj' AND  idtarj = '$Pid0' AND etapa = '2'  AND activo ='SI' ";
                                    $qbdpros = $dbc->query($bdpros);
                                }else{
                                    $bdpros= "SELECT * FROM $lead_task WHERE tipotarj = '$tipotarj' AND  idtarj = '$Pid0' AND etapa = '2' AND usertask LIKE '%$userLog%' OR usuarioregistra = '$userLog'  ";
                                    $qbdpros = $dbc->query($bdpros);
                                }
            ...
            <div id="backVIDEO">
                ...
                <div id="backahistorias">
                    ...
                    <div id="backtab">
                            ...
                            if($adminrol== $radmin ){
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'VIDEOLLAMADA' AND etapa = '2'  AND activo ='SI' ";
                                $qbdpros = $dbc->query($bdpros);
                            }else{
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'VIDEOLLAMADA' AND etapa = '2' AND usertask LIKE '%$userLog%' OR usuarioregistra = '$userLog'  ";
                                $qbdpros = $dbc->query($bdpros);
                            }
                ...
                <div id="backahistorias">
                    ...
                    <div class="namecotasky left"><p>Bitácora de Conversaciones</p></div>
                       ...
                       <div id="backtab">
                                ...
                                if($adminrol== $radmin ){
                                    $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'WHATSAPP' AND etapa = '2'  AND activo ='SI' ";
                                    $qbdpros = $dbc->query($bdpros);
                                }else{
                                    $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'WHATSAPP' AND etapa = '2' AND usertask LIKE '%$userLog%' OR usuarioregistra = '$userLog'  ";
                                    $qbdpros = $dbc->query($bdpros);
                                }
            ...
            <div id="backllamada">
                ...
                <div id="backahistorias">
                    ...
                    <div id="backtab">
                            ...
                            if($adminrol== $radmin ){
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'LLAMADA' AND etapa = '2'  AND activo ='SI' ";
                                $qbdpros = $dbc->query($bdpros);
                            }else{
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'LLAMADA' AND etapa = '2' AND usertask LIKE '%$userLog%' OR usuarioregistra = '$userLog'  ";
                                $qbdpros = $dbc->query($bdpros);
                            }
            ...
            <div id="backdelcliente">
                ...
                <div id="backahistorias">
                    ...
                    <div id="backtab">
                            ...
                            if($adminrol== $radmin ){
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'DEL CLIENTE' AND etapa = '2'  AND activo ='SI' ";
                                $qbdpros = $dbc->query($bdpros);
                            }else{
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'DEL CLIENTE' AND etapa = '2' AND usertask LIKE '%$userLog%' OR usuarioregistra = '$userLog'  ";
                                $qbdpros = $dbc->query($bdpros);
                            }
            ...
            <div id="backALcliente">
                ...
                <div id="backahistorias">
                    ...
                    <div id="backtab">
                            ...
                            if($adminrol== $radmin ){
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'AL CLIENTE' AND etapa = '2'  AND activo ='SI' ";
                                $qbdpros = $dbc->query($bdpros);
                            }else{
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'AL CLIENTE' AND etapa = '2' AND usertask LIKE '%$userLog%' OR usuarioregistra = '$userLog'  ";
                                $qbdpros = $dbc->query($bdpros);
                            }
            ...
            <div id="backotros">
                ...
                <div id="backahistorias">
                    ...
                    <div id="backtab">
                            ...
                            if($adminrol== $radmin ){
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'OTROS' AND etapa = '2'  AND activo ='SI' ";
                                $qbdpros = $dbc->query($bdpros);
                            }else{
                                $bdpros= "SELECT * FROM $hist_comentlead WHERE tipotarjeta = '$tipotarj' AND  idtarjeta = '$Pid0' AND tipocom = 'OTROS' AND etapa = '2' AND usertask LIKE '%$userLog%' OR usuarioregistra = '$userLog'  ";
                                $qbdpros = $dbc->query($bdpros);
                            }
