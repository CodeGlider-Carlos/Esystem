        ...
        <?php
            ...
            if(isset($_POST['savemod'])){
                ...
                ?>
                    ...
                    <form method="POST" action="coti.php" id="backregresar">
                ...
                if($tipotarj == 'EMPRESA'){
                    ...
                    $updetapa2 = "UPDATE $cat_tarjetas_leademp SET valorfin='$valorfin' WHERE id='$Pid0' ";
                    $qupdetapa2 = $dbc->query($updetapa2);
                }else{
                    $procedimiento = $_POST['procedimiento'];
                    $tabprec= "SELECT * FROM $tabPrelead WHERE procedimiento  = '$procedimiento' ";
                    $qtabprec = $dbc->query($tabprec);
                    
                    while ($filpro = $qtabprec->fetch(PDO::FETCH_ASSOC)) {
                        $precioho =$filpro['preciohosp'];
                        $procedimien =$filpro['procedimiento'];
                    }
                    
                    $updetapa = "UPDATE $cat_tarjetas_leadpx SET estatus='$etapa' WHERE id='$Pid0' ";
                    $qupdetapa = $dbc->query($updetapa);
    
                    $updateproce = "UPDATE $cat_tarjetas_leadpx SET procedimiento='$procedimien' WHERE id='$Pid0' ";
                    $qupdateproce = $dbc->query($updateproce);
    
                    
                    $updatpre = "UPDATE $cat_tarjetas_leadpx SET valorfin='$precioho' WHERE id='$Pid0' ";
                    $qupdatpre   = $dbc->query($updatpre);
