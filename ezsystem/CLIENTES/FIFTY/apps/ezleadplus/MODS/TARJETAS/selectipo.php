...
<body>
    ...
    <modseg  id="modprosp">
        ...
        <section id="section1a" class="sectionmod">
            ...
            <form class="tabcposELECT1" method="POST"  action="tipotarjeta.php" autocomplete="off" onkeydown="return event.key != 'Enter';" >
                <div for="person" class="label">Tipo de prospecto</div>
                <select id="person" name="tipopro" class="input" required>
