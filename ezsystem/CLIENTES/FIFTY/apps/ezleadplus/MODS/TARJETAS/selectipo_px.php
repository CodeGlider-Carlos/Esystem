...
<body>
    ...
    <modseg  id="modprosp">
        ...
        <section id="section1a" class="sectionmod">
            ...
            <div class="namesect" id="namesect1">BUSCAR PROSPECTO</div>


            <form class="tabcposELECT1" method="POST"  action="tarjetas_px.php" autocomplete="off" onkeydown="return event.key != 'Enter';" >
               <select hidden id="person" name="tipopro" class="input" >
                ...
                <div for="person" class="label">Nombre de Paciente</div>
                <input type="list" list="persony"  id="person" name="person" class="input" >


                <input type="submit" value="CONTINUAR" id="GUARDAR">
