...
$bdpros0= "SELECT * FROM $crm_prosPxLead WHERE nombre  = '$person' ";
...
<body>
    ...
    <modseg  id="modprosp">
        ...
        <section id="section1" class="sectionmod">
            ...
            <div class="namesect" id="namesect1">TARJETA DE PACIENTE</div>
            ...
            <div id="block0">
                ...
                <div id="backfotoname">
                    ...
                    <div id="backfotoALL">
                        ...
                        <div class="labelTarj" id="especialidadTXT">Procedimiento</div>
                        <div class="txtarj" id="procedimi"><strong><?php echo $procedimiento;?></strong></div>
                            ...
                            ?>
                                ...
                                <table class="tablered">
                                    ...
                                    <?php
                                            ...
                                            $bdpros= "SELECT * FROM $cat_tarjetas_leadpx WHERE nombre  = '$person' ";
                ...
                <section id="section2" class="sectionmodVINCMED">
                    ...
                    <form class="tabcposELECT" method="POST" action="save_tarj_px.php"  autocomplete="off" onkeydown="return event.key != 'Enter';" >
                        

                    

                        <input hidden type="text" value="<?php echo $Pid0;?>" name="idpx">
