...
if (isset($_POST['savetarj'])){
  ...
  if($accion == 'ALTA'){
    ...
    $bdpros= "SELECT * FROM $crm_prosElead WHERE id = '$idemp' ";
    ...
    while ($filpro = $qbdpros->fetch(PDO::FETCH_ASSOC)) {
      ...
      $valyred= "SELECT * FROM $cat_tarjetas_leademp WHERE idemp = '$Pidmed'  ";
      ...
      if(empty($valred)){
            ...
            $insertar = "INSERT INTO $cat_tarjetas_leademp VALUES (NULL,'$region','$unidad','$categoria','$idemp',
            '$nombreEMP','$acronimo','$valor',NULL,'MXN','$userLog','$fechahoy',NULL,NULL,'1','1' )";
...
<body>
    ...
    <modseg  id="modprosp">
        ...
        <form method="POST" action="tarjetas.php" id="backregresar">
