...
<body>
    ...
    <modseg  id="modprosp">
        ...
        <section id="section1a" class="sectionmod">
            ...
            <form class="tabcposELECT1" method="POST"  action="tarjetas_emp.php" autocomplete="off" onkeydown="return event.key != 'Enter';" >
               <select hidden id="person" name="tipopro" class="input" >
                ...
                <datalist id="empre">
                    ...
                    <?php
                        ...
                        <option value="<?php echo $opciones['acron']?>"><?php echo $opciones['acron']?></option>
                        <?php
                        }
                ...
                <div for="person" class="label">Nombre de Empresa</div>
                <input type="list" list="empre"  id="empresa" name="person" class="input" >
