...
<body>
    ...
    <modseg id="modprosp">
        ...
        <section id="section1" class="sectionmod">
            ...
            <div class="namesect" id="namesect1">AGREGAR PACIENTE</div>
            ...
            if (isset($_POST['modemp'])) {
                ...
                if ($adminrol == $radmin) {
                    $tabprosemp = "SELECT * FROM $crm_prosPxLead WHERE id = '$idpros'  ";
                } elseif ($adminrol == $radger) {
                    $tabprosemp = "SELECT * FROM $crm_prosPxLead WHERE id = '$idpros'  ";
                } else {
                    $tabprosemp = "SELECT * FROM $crm_prosPxLead WHERE id = '$idpros'  AND useralta = '$userLog'  OR useresp = '$userLog' ";
                }
            ...
            ?>
                ...
                <form method="POST" action="prospect_emp.php" autocomplete="off" onkeydown="return event.key != 'Enter';">
                    ...
                    <input type="submit" value="EMPRESAS" class="botprosp1b">

                </form>

                <form method="POST" action="prospect_px.php" autocomplete="off" onkeydown="return event.key != 'Enter';">

                    <input type="submit" value="PACIENTES" class="botprosp2b">

                </form>

                <form class="tabcpo" method="POST" action="save_px.php" autocomplete="off" onkeydown="return event.key != 'Enter';">
                    ...
                    <select id="fuente" name="fuente" class="select">
                        <option value=""><?php echo $fuente; ?></option>
                        <option value=""></option>
                    ...
                    <textarea id="obs" name="obs" class="textarea" spellcheck="false" placeholder="<?php echo $obsy; ?>">
            ...
            ?>
                ...
                <form class="tabcpo" method="POST" action="save_px.php" autocomplete="off" onkeydown="return event.key != 'Enter';">
                    ...
                    <div for="NOM" class="label">Nombre</div>
                    <input type="text" id="organizacion" name="nombrepx" class="input" required>
                    ...
                    <div for="NOM" class="label">Procedimiento de interés</div>
                    <input type="text" id="procedimiento" name="procedimiento" class="input" required>
                    ...
                    <select id="useresp" name="useresp" class="select" required>
                        ...
                        if ($adminrol == $radmin) {
                            ...
                            $tabuslead = "SELECT * FROM $users_leadlead WHERE user =  '$userLog'  ";
                        }
                        ...
                        foreach ($qtabuslead as $opciones) { ?>
                            ...
                            <option value="<?php echo $opciones['user']; ?>"><?php echo $opciones['user']; ?></option>
                    ...
                    <input class="savemod" type="submit" value="GUARDAR" id="GUARDAR" name="savepx">
                ...
                <div id="backtab">
                    ...
                    <table class="table">
                        ...
                        <tr class="title">
                            ...
                            <td>Procedimiento de Interés</td>
                            <td>Especialidad</td>
                        ...
                        if ($adminrol == $radmin) {
                            $bdpros = "SELECT * FROM $crm_prosPxLead ";
                            $qbdpros = $dbc->query($bdpros);
                        } elseif ($adminrol == $radger) {
                            $bdpros = "SELECT * FROM $crm_prosPxLead WHERE region LIKE '%$userAcroregion%' ";
                            $qbdpros = $dbc->query($bdpros);
                        } else {
                            $bdpros = "SELECT * FROM $crm_prosPxLead WHERE useresp LIKE '%$userLog%' ";
                            $qbdpros = $dbc->query($bdpros);
                        }
                        ...
                        ?>
                            <tr class="fil">
                                ...
                                <td class="center"><?php echo $procedimiento; ?></td>

                                <td class="center"><?php echo $especialidad; ?></td>
                                <td class="center"><?php echo $fuente; ?></td>
                                <td class="center"><?php echo $Puseresp; ?></td>
                                <td class="center"><?php echo $obsy; ?></td>
                                <td class="center">
