...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="PRINT/css/printy.css">
...
<body>
    ...
    <section id="backallres">
        ...
        <div id="back_filtrarPrint">



   
            <form id="form1"  method="POST" action="PRINT/print.php" autocomplete="off" target="_blank" >

                <div class="namesect">IMPRESIONES</div>
            ...
            <form id="form2"  method="POST" action="PRINT/dash_print.php" autocomplete="off" target="_blank" >

                    <div class="namesect">REPORTE EJECUTIVO</div>
                    ...
                    <select name="region" id="tipotask" class="input" >  
                        <option value="" selected>Región...</option>  
                        <option value="JAL" >JALISCO</option>
                        <option value="PUE" >PUEBLA</option>
                    ...
                    <select id="cliente" name="unidadSel"  class="input" required >  
                        ...
                        <?php
                            ...
                            if($adminrol == $radmin ){
                                ...
                                $tabunid = "SELECT * FROM $clirisk WHERE acronu = '$userAcronu' AND ver = 'SI' ";
                                $qtabunid = $db_users->query($tabunid);
                                ...
                                $tabunid = "SELECT * FROM $clirisk WHERE acronu = '$userUnidadAcronu' AND ver = 'SI' ";
                                $qtabunid = $db_users->query($tabunid);
            ...
            <div id="botonesSlid">
                <div class="botonCircle" id="bop1"></div>
                <div class="botonCircle" id="bop2"></div>
            </div>
        </div>
