...
<body id="bodydash">
        ...
        <section id="backtaskPrint">

            <div class="ejecuName">REPORTE EJECUTIVO/TAREAS</div>
            <div class="prontFIl">
                <?php
                        echo $yearho .'/'.$periodo.'/'.$region.'/'.$unidadcli.'/'.$usertask.'/'.$fechaHy;
                ?>
            </div>
                ...
                <?php
                    ...
                    if($adminrol == $radmin){
                        ...
                        if(empty($usertask)){
                            ...
                            $AtaskCumplidas = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )   AND activo = 'SI'  AND usertask = '$usertask' ")->fetch());
                        $AtaskEnCurso = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladas = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%CANCELADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadas= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%REASIGNADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotal = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        ...
                        $AtaskCumplidasM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND activo = 'SI'  AND usertask = '$usertask' ")->fetch());
                        $AtaskEnCursoM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'    AND estatus LIKE '%CANCELADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM1= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'    AND estatus LIKE '%REASIGNADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
        
                        $allcumpleMes1 = $AtaskCumplidasM1+$AtaskEnCursoM1;
                        $allmes1 = $AtaskTotalM1-$AtaskCanceladasM1-$AtaskReasignadasM1;

                        $AtaskCumplidasM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'    AND estatus LIKE '%CANCELADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM2= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'    AND estatus LIKE '%REASIGNADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        
                        $allcumpleMes2 = $AtaskCumplidasM2+$AtaskEnCursoM2;
                        $allmes2 = $AtaskTotalM2-$AtaskCanceladasM2-$AtaskReasignadasM2;

        
                        $AtaskCumplidasM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )    AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'    AND estatus LIKE '%CANCELADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM3= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'    AND estatus LIKE '%REASIGNADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
        
                        $allcumpleMes3 = $AtaskCumplidasM3+$AtaskEnCursoM3;
                        $allmes3 = $AtaskTotalM3-$AtaskCanceladasM3-$AtaskReasignadasM3;

                        $AtaskCumplidasM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')   AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskCanceladasM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'    AND estatus LIKE '%CANCELADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM4= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'    AND estatus LIKE '%REASIGNADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        
                        $allcumpleMes4 = $AtaskCumplidasM4+$AtaskEnCursoM4;
                        $allmes4 = $AtaskTotalM4-$AtaskCanceladasM4-$AtaskReasignadasM4;

                        $AtaskCumplidasM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )    AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'    AND estatus LIKE '%CANCELADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM5= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'    AND estatus LIKE '%REASIGNADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
        
                        $allcumpleMes5 = $AtaskCumplidasM5+$AtaskEnCursoM5;
                        $allmes5 = $AtaskTotalM5-$AtaskCanceladasM5-$AtaskReasignadasM5;

                        $AtaskCumplidasM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskCanceladasM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'    AND estatus LIKE '%CANCELADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM6= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'    AND estatus LIKE '%REASIGNADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        
                        $allcumpleMes6 = $AtaskCumplidasM6+$AtaskEnCursoM6;
                        $allmes6 = $AtaskTotalM6-$AtaskCanceladasM6-$AtaskReasignadasM6;

        
                        $AtaskCumplidasM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )  AND activo = 'SI'  AND usertask = '$usertask' ")->fetch());
                        $AtaskEnCursoM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskCanceladasM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'    AND estatus LIKE '%CANCELADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM7= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'    AND estatus LIKE '%REASIGNADA%' AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
        
                        $allcumpleMes7 = $AtaskCumplidasM7+$AtaskEnCursoM7;
                        $allmes7 = $AtaskTotalM7-$AtaskCanceladasM7-$AtaskReasignadasM7;

                        $AtaskCumplidasM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')   AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskCanceladasM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'    AND estatus LIKE '%CANCELADA%'   AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskReasignadasM8= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'    AND estatus LIKE '%REASIGNADA%'   AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskTotalM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
        
                        $allcumpleMes8 = $AtaskCumplidasM8+$AtaskEnCursoM8;
                        $allmes8 = $AtaskTotalM8-$AtaskCanceladasM8-$AtaskReasignadasM8;

                        $AtaskCumplidasM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )    AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'    AND estatus LIKE '%CANCELADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM9= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'    AND estatus LIKE '%REASIGNADA%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'  AND activo = 'SI'  AND usertask = '$usertask' ")->fetch());
                    
                        $allcumpleMes9 = $AtaskCumplidasM9+$AtaskEnCursoM9;
                        $allmes9 = $AtaskTotalM9-$AtaskCanceladasM9-$AtaskReasignadasM9;

        
                        $AtaskCumplidasM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'    AND estatus LIKE '%CANCELADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM10= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'    AND estatus LIKE '%REASIGNADA%'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
        
                        $allcumpleMes10 = $AtaskCumplidasM10+$AtaskEnCursoM10;
                        $allmes10 = $AtaskTotalM10-$AtaskCanceladasM10-$AtaskReasignadasM10;

                        $AtaskCumplidasM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )   AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskEnCursoM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'    AND estatus LIKE '%CANCELADA%' AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                        $AtaskReasignadasM11= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'    AND estatus LIKE '%REASIGNADA%'   AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                        
                        $allcumpleMes11 = $AtaskCumplidasM11+$AtaskEnCursoM11;
                        $allmes11 = $AtaskTotalM11-$AtaskCanceladasM11-$AtaskReasignadasM11;

        
                        $AtaskCumplidasM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )    AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                        $AtaskEnCursoM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO')  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                        $AtaskCanceladasM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'    AND estatus LIKE '%CANCELADA%'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                        $AtaskReasignadasM12= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'    AND estatus LIKE '%REASIGNADA%'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                        $AtaskTotalM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                        ...
                        if(empty($usertask)){
                            ...
                            $AtaskCumplidas = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion' AND usertask = '$usertask'   AND activo = 'SI' ")->fetch());
                            $AtaskEnCurso = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                            $AtaskCanceladas = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                            $AtaskReasignadas= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                            $AtaskTotal = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
                            ...
                            $AtaskCumplidasM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'  AND usertask = '$usertask'   AND activo = 'SI' ")->fetch());
                            $AtaskEnCursoM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion' AND usertask = '$usertask'  AND activo = 'SI'  ")->fetch());
                            $AtaskCanceladasM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                            $AtaskReasignadasM1= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                            $AtaskTotalM1 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%01%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
            
                            $allcumpleMes1 = $AtaskCumplidasM1+$AtaskEnCursoM1;
                            $allmes1 = $AtaskTotalM1-$AtaskCanceladasM1-$AtaskReasignadasM1;
    
                            $AtaskCumplidasM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion' AND usertask = '$usertask'   AND activo = 'SI' ")->fetch());
                            $AtaskEnCursoM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND usertask = '$usertask'  AND activo = 'SI'  ")->fetch());
                            $AtaskReasignadasM2= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND usertask = '$usertask'  AND activo = 'SI'  ")->fetch());
                            $AtaskTotalM2 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%02%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
                            
                            $allcumpleMes2 = $AtaskCumplidasM2+$AtaskEnCursoM2;
                            $allmes2 = $AtaskTotalM2-$AtaskCanceladasM2-$AtaskReasignadasM2;
    
            
                            $AtaskCumplidasM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskReasignadasM3= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskTotalM3 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%03%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
            
                            $allcumpleMes3 = $AtaskCumplidasM3+$AtaskEnCursoM3;
                            $allmes3 = $AtaskTotalM3-$AtaskCanceladasM3-$AtaskReasignadasM3;
    
                            $AtaskCumplidasM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskReasignadasM4= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskTotalM4 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%04%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
                            
                            $allcumpleMes4 = $AtaskCumplidasM4+$AtaskEnCursoM4;
                            $allmes4 = $AtaskTotalM4-$AtaskCanceladasM4-$AtaskReasignadasM4;
    
                            $AtaskCumplidasM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskReasignadasM5= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskTotalM5 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%05%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
            
                            $allcumpleMes5 = $AtaskCumplidasM5+$AtaskEnCursoM5;
                            $allmes5 = $AtaskTotalM5-$AtaskCanceladasM5-$AtaskReasignadasM5;
    
                            $AtaskCumplidasM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskCanceladasM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskReasignadasM6= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskTotalM6 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%06%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
                            
                            $allcumpleMes6 = $AtaskCumplidasM6+$AtaskEnCursoM6;
                            $allmes6 = $AtaskTotalM6-$AtaskCanceladasM6-$AtaskReasignadasM6;
    
            
                            $AtaskCumplidasM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskCanceladasM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskReasignadasM7= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskTotalM7 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%07%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
            
                            $allcumpleMes7 = $AtaskCumplidasM7+$AtaskEnCursoM7;
                            $allmes7 = $AtaskTotalM7-$AtaskCanceladasM7-$AtaskReasignadasM7;
    
                            $AtaskCumplidasM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskReasignadasM8= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskTotalM8 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%08%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
            
                            $allcumpleMes8 = $AtaskCumplidasM8+$AtaskEnCursoM8;
                            $allmes8 = $AtaskTotalM8-$AtaskCanceladasM8-$AtaskReasignadasM8;
    
                            $AtaskCumplidasM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskReasignadasM9= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskTotalM9 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%09%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
                        
                            $allcumpleMes9 = $AtaskCumplidasM9+$AtaskEnCursoM9;
                            $allmes9 = $AtaskTotalM9-$AtaskCanceladasM9-$AtaskReasignadasM9;
    
            
                            $AtaskCumplidasM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskReasignadasM10= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskTotalM10 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%10%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
            
                            $allcumpleMes10 = $AtaskCumplidasM10+$AtaskEnCursoM10;
                            $allmes10 = $AtaskTotalM10-$AtaskCanceladasM10-$AtaskReasignadasM10;
    
                            $AtaskCumplidasM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskEnCursoM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskCanceladasM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask' ")->fetch());
                            $AtaskReasignadasM11= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI'  AND usertask = '$usertask'  ")->fetch());
                            $AtaskTotalM11 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%11%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
                            
                            $allcumpleMes11 = $AtaskCumplidasM11+$AtaskEnCursoM11;
                            $allmes11 = $AtaskTotalM11-$AtaskCanceladasM11-$AtaskReasignadasM11;
    
            
                            $AtaskCumplidasM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND  region = '$userAcroregion'   AND activo = 'SI'AND usertask = '$usertask'   ")->fetch());
                            $AtaskEnCursoM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'    AND (estatus = 'EN_CURSO' OR estatus = 'EN CURSO') AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'   ")->fetch());
                            $AtaskCanceladasM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'    AND estatus LIKE '%CANCELADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskReasignadasM12= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'    AND estatus LIKE '%REASIGNADA%' AND region = '$userAcroregion'  AND activo = 'SI' AND usertask = '$usertask'  ")->fetch());
                            $AtaskTotalM12 = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%12%'  AND activo = 'SI' AND region = '$userAcroregion' AND usertask = '$usertask'  ")->fetch());
                        ...
                        if(empty($usertask)){
                            ...
                            $AtaskCumplidas = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' ) AND usertask = '$usertask'  AND activo = 'SI' ")->fetch());
                            $AtaskEnCurso = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND estatus LIKE '%EN_CURSO%' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                            $AtaskCanceladas = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%CANCELADA%' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                            $AtaskReasignadas= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND estatus LIKE '%REASIGNADA%' AND usertask = '$usertask'   AND activo = 'SI'  ")->fetch());
                    ...
                    <?php
                            ...
                            while ($fila = $qvalyuser->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                if($adminrol == $radmin){
                                    ...
                                    $taskCumplidasT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'  AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )   AND activo = 'SI' AND tipominuta = '$acronimoMIN' AND usertask = '$usertask' ")->fetch());
                                    $taskEnCursoT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%EN_CURSO%' AND activo = 'SI' AND tipominuta = '$acronimoMIN' AND usertask = '$usertask' ")->fetch());
                                    $taskCanceladasT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%CANCELADA%' AND activo = 'SI'  AND tipominuta = '$acronimoMIN' AND usertask = '$usertask' ")->fetch());
                                    $taskReasignadasT= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%REASIGNADA%' AND activo = 'SI'  AND tipominuta = '$acronimoMIN' AND usertask = '$usertask' ")->fetch());
                                    
                                    
                                    
                                    $taskTotalT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%' AND activo = 'SI'   AND tipominuta = '$acronimoMIN' AND usertask = '$usertask' ")->fetch());
                                    ...
                                    $taskCumplidasT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'  AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )   AND activo = 'SI' AND (region = '$userAcroregion' OR usuarioregistra = '$userLog') AND tipominuta = '$acronimoMIN'  ")->fetch());
                                    $taskEnCursoT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND estatus LIKE '%EN_CURSO%' AND activo = 'SI' AND (region = '$userAcroregion' OR usuarioregistra = '$userLog') AND tipominuta = '$acronimoMIN'  ")->fetch());
                                    $taskCanceladasT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%CANCELADA%' AND activo = 'SI' AND (region = '$userAcroregion' OR usuarioregistra = '$userLog')  AND tipominuta = '$acronimoMIN'  ")->fetch());
                                    $taskReasignadasT= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%REASIGNADA%' AND activo = 'SI' AND (region = '$userAcroregion' OR usuarioregistra = '$userLog') AND tipominuta = '$acronimoMIN'   ")->fetch());
                                    
                                    
                                    
                                    $taskTotalT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'  AND activo = 'SI' AND (region = '$userAcroregion' OR usuarioregistra = '$userLog') AND tipominuta = '$acronimoMIN'   ")->fetch());
                                    ...
                                    $taskCumplidasT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND (estatus = 'EN_FECHA' OR estatus = 'CUMPLIDA' OR estatus = 'DESPUES_DE_FECHA' )   AND activo = 'SI' AND usertask = '$userLog'  AND tipominuta = '$acronimoMIN'   ")->fetch());
                                    $taskEnCursoT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'   AND estatus LIKE '%EN_CURSO%' AND activo = 'SI' AND usertask = '$userLog'  AND tipominuta = '$acronimoMIN'   ")->fetch());
                                    $taskCanceladasT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%CANCELADA%' AND activo = 'SI' AND usertask = '$userLog' AND tipominuta = '$acronimoMIN'    ")->fetch());
                                    $taskReasignadasT= current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'    AND estatus LIKE '%REASIGNADA%' AND activo = 'SI' AND usertask = '$userLog'  AND tipominuta = '$acronimoMIN'    ")->fetch());
                                    
                                    
                                    
                                    $taskTotalT = current($db_task->query("SELECT COUNT(*) FROM $tabtaskY  WHERE  yearfinpro LIKE '%$yearho%' AND unidad LIKE '%$unidadcli%' AND mesfinpro LIKE '%$periodo%'  AND activo = 'SI' AND usertask = '$userLog'  AND tipominuta = '$acronimoMIN'    ")->fetch());
