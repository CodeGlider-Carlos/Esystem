...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/eval_task.css">
                    ...
                    <table id="tablataUpd">
                        ...
                        <?php
                                ...
                                while ($regitask = $ejeccheck->fetch(PDO::FETCH_ASSOC))  {
                                    ...
                                    if(empty($fpg2)){
                                        $classaTASK="INPUTASKb";
                                    }else{
                                        $classaTASK="INPUTASKyab";
                                    }
                                    ...
                                    echo '
                                        ...
                                        <tr id="bloq0">
                                            ...
                                            <td colspan="7" ><div class="lineaTask"></div></td>
                                        ...
                                        <tr id="">
                                                ...
                                                <td class="inputBb" >' . $regitask['id'] . '</td>
                                                <td colspan="3">
                                                    <textarea class="'.$classaTASK.'"  spellcheck="false" readonly>' . $regitask['tarea'] . '</textarea>
                                             
                                                </td>   

                                            
                                                <td ><input type="text"  class=" inputT center" value="' . $fechaUno . ' " readonly></td>
                                                    ...
                                                    if(empty($fpg2) OR $fpg2 == NULL OR $fpg2 == "0000-00-00"){
                                                        ...
                                                        echo '
                                                            <td ><input type="date"  class="inputT" value="Fecha Real" name="fechacumpleUpdate[' . $regitask['id'] . ']"></td>
                                                        ...
                                                        ';
                                                            ...
                                                            <td><input tupe="text" class="inputT" name="fechacumpleUpdate[' . $regitask['id'] . ']"  placeholder="' . $fpg2 . ' o (AAAA-MM-DD)"></td>
                                                    ...
                                                    echo '
                                                <td colspan="1"><textarea type="text"  class="inputOBS" spellcheck="false" placeholder="' . $regitask['observaciones'] . '" readonly></textarea></td>
                                        ...
                                        <tr id="bloq1b">
                                            ...
                                            <td></td>
                                            <td>
                                                <select class="inputest" name="estatusUpdate[' . $regitask['id'] . ']" value="' . $regitask['estatus'] . '" >
                                        ...
                                        <tr id="bloq3b"> 
                                            ...
                                            <td colspan="3" class="inputTY" >' . $regitask['responsabletarea'] . '</td>
                                         
                                            <td></td>  
                                            <td></td>  
                                            <td></td>  
                                            <td></td>                     
                                            <td colspan="2"><textarea type="text"  class="inputEVALobst justy" spellcheck="false" name="obscUpdate[' . $regitask['id'] . ']" placeholder="' . $regitask['observacionescumple'] . '"></textarea></td>
                                        ...
                                        if(empty($rutaEvaly)){
                                            ...
                                            echo '
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="activ2" ></td>
                                                    <td class="activ2" ><a href="' . $regitask['ruta'] .'" class="botmenu" id="verdoc" target="_blank">VER EVIDENCIA</a></td>
                                                </tr>
                                            ';
