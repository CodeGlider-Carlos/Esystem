    ...
    <section>
        ...
        <form method="POST" action="calcm.php" autocomplete="off">
            ...
            <section id="backpob">
                ...
                <input type="text" name="N" id="tamues" placeholder="tamaño de la población..." number_format>
                ...
                <div id="confianza">
                    ...
                    <label class="content-input po1">
                        <input type="radio" name="z" value="<?php $conf1 = 2.58; echo $conf1; ?>" id="99">
                        <i></i>
                    </label>
                    <label class="content-input po2">
                        <input type="radio" name="z" value="<?php $conf2 = 2.38; echo $conf2; ?>" id="97">
                        <i></i>
                    </label>
                    <label class="content-input po3">
                        <input type="radio" name="z" value="<?php $conf3 = 1.96; echo $conf3; ?>" id="95">
                        <i></i>
                    </label>
                    <label class="content-input po4">
                        <input type="radio" name="z" value="<?php $conf4 = 1.76; echo $conf4; ?>" id="92">
                        <i></i>
                    </label>
                    <label class="content-input po5">
                        <input type="radio" name="z" value="<?php $conf5 = 1.645; echo $conf5; ?>" id="90">
                        <i></i>
                    </label>
                ...
                <input type="submit" id="buscarrisk" name="calcularfinita" value="CALCULAR" >        
