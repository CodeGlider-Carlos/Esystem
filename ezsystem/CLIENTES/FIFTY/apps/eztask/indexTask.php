...
<body>
    ...
    <navleft id="navleft">
        ...
        <div class="bakBoton">
            ...
            <div id="txt4" class="txttx"><strong>DASHBOARD</strong></div>
    ...
    <section id="backallres">
        ...
        <div id="back_filtrar">
            ...
            <form  method="POST" action="dirtask.php" autocomplete="off">                
                    ...
                    <div class="namesect">ASIGNAR TAREAS</div>
                    ...
                    <select name="tipotask" id="tipotask" class="input" required>  
                    ...
                    <select hidden name="accion" required class="input">
