...
$namepaqq = "SELECT * FROM $cat_paq WHERE procedimiento = '$paquete'  ";
...
$tabpaqvent = "SELECT * FROM $tabproced WHERE procedimiento = '$paquete'  ";
                ...
                <div id="backverCoti">   
                    ...
                    <div class="namecotasky left">Cotización</div>
                        ...
                        if(empty($valyProdced)){
                            ...
                            if($vincumod == 'VINCULAR'){

                                ?>                          

                                    <form  method="POST" action="saveCoti.php" autocomplete="off">
                                        ...
                                        <input type="submit" value="VINCULAR" name="savePaq" id="vincularBoton">
                                        ...
                                        <table id="tablecotiz">
                                            ...
                                            <?php
                                                    ...
                                                    ////////////////////////////////////////////////DATOS ARTICULOS
                                                    $valydpaq = "SELECT * FROM $cat_paqBA WHERE idpaq = '$idpaq' AND activo = 'SI'   ORDER BY tipo ASC ";
                                                    $qvalydpaq = $dbcot->query($valydpaq);                    
                                                        ...
                                                        while ($filas = $QPRECIO->fetch(PDO::FETCH_ASSOC)) {
                                                            ...
                                                            echo '
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td hidden><input type="text" name="id_vinc[]" value="' . $fila['id'] . '"></td>


                                                                    <td hidden> <input type="text" class="center inputVCo" name="idpaq[' . $fila['id'] .  ']" value="' . $idpaqy . '">  </td>
                                                                    ...
                                                                    <td ><input type="list" list="cat_pre" class="left inputVCo "  value="' . $artiser .  '"></td>
                                ...
                                <form  method="POST" action="saveCoti.php" autocomplete="off">
                                      ...
                                      <table id="tablecotiz">
                                          ...
                                          <?php
                                                  ...
                                                  ////////////////////////////////////////////////DATOS ARTICULOS
                                                  $valydpaqu = "SELECT * FROM $cat_paquetes_med WHERE idtarj = '$idtarjeta' AND activo = 'SI'   ";
                                                  $qvalydpaqu = $dbcot->query($valydpaqu);                    


                                                  while ($fila = $qvalydpaqu->fetch(PDO::FETCH_ASSOC)) {
                                                      ...
                                                      $precioventa = $filas['precioventa']; 
                                                          ...
                                                          echo '
                                                              ...
                                                              <tr>
                                                                  ...
                                                                  <td hidden> <input type="text" class="center inputVCo" name="idpaq[' . $fila['id'] .  ']" value="' . $idpaqy . '">  </td>
                                                                  <td hidden> <input type="text" class="center inputVCo" name="idsapLY[' . $fila['id'] .  ']" value="' . $idsap . '">  </td>

                                                                  <td > <input type="text" class="center inputVCo" name="tipoLY[' . $fila['id'] .  ']" value="' . $tipo . '">  </td>
                                                                  <td hidden> <input type="text" class="center inputVCo" name="artiserLY[' . $fila['id'] .  ']" value="' . $artiser . '">  </td>
                                                                  <td hidden>
                                                                      <input type="number" class="center inputVCo" name="costoLY[' . $fila['id'] .  ']" value="' . $costoP . '"> 
                                                              
                                                                  </td>
                                                                  <td hidden>
                                                                      <input type="number" class="center inputVCo" name="factorLY[' . $fila['id'] .  ']" value="' . $factorP . '"> 
