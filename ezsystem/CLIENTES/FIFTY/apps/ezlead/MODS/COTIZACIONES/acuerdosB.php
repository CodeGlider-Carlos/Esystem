...
$precioventa = current($dbcot->query("SELECT SUM(precioventa) FROM $cat_paquetes_med WHERE idpaq = '$idpaq' AND activo = '1'  ")->fetch());
...
?>
    <div id="analisisCOTI">
        ...
        <?php
            ...
            $preciosinfactor = current($dbcot->query("SELECT SUM(preciosinfactor) FROM $cat_paquetes_med WHERE idpaq = '$idpaq' AND activo = '1'  ")->fetch());
        ...
        //$utilidadFIN= $precioventa+$aumeOT-$precioPROMO-$totdesc-$comSO-$comOT-$comisionVCo-$preciosinfactor;
            ...
            $precioventaMED = current($dbcot->query("SELECT SUM(precioventa) FROM $cat_paquetes_med WHERE idpaq = '$idpaq' AND activo = '1' AND tipo = 'MEDICAMENTOS' ")->fetch());
            $precioventaINS = current($dbcot->query("SELECT SUM(precioventa) FROM $cat_paquetes_med WHERE idpaq = '$idpaq' AND activo = '1' AND tipo = 'INSUMOS' ")->fetch());
