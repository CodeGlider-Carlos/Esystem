    ...
    <modseg  id="modprosp">
        ...
        <?php
            ...
            if (isset($_POST['savepROG'])){
                ...
                $procedimiento0 = $_POST['procedimiento0'];

                $fechareal = $_POST['fechapro'];
                $fechc= new DateTime( $fechareal );

                $fechapro = $fechc->format('Y-m-d');

                $costo = $_POST['costo'];
                $venta = $_POST['venta'];
                $utilporce = $_POST['utilporce'];
                $utilmon = $_POST['utilmon'];
                $satmed = $_POST['satmed'];
                $satpx = $_POST['satpx'];
                $sathosp = $_POST['sathosp'];
                ...
                $updetapa1 = "UPDATE $cat_tarjetas_med SET fechareal='$fechapro' WHERE id='$Pid0' ";
                $Qupdetapa1 = $dbc->query($updetapa1);

                $updetapa2 = "UPDATE $cat_tarjetas_med SET costofin='$costo' WHERE id='$Pid0' ";
                $qupdetapa2 = $dbc->query($updetapa2);

                $updetapa3 = "UPDATE $cat_tarjetas_med SET preciofin='$venta' WHERE id='$Pid0' ";
                $qupdetapa3 = $dbc->query($updetapa3);

                $updetapa4 = "UPDATE $cat_tarjetas_med SET porceutifin='$utilporce' WHERE id='$Pid0' ";
                $qupdetapa4 = $dbc->query($updetapa4);

                $updetapa5 = "UPDATE $cat_tarjetas_med SET utifinmo='$utilmon' WHERE id='$Pid0' ";
                $qupdetapa5 = $dbc->query($updetapa5);

              
                $updetapa = "UPDATE $cat_tarjetas_med SET satimed='$satmed' WHERE id='$Pid0' ";
                $qupdetapa = $dbc->query($updetapa);

                
                $updetapa7 = "UPDATE $cat_tarjetas_med SET satipx='$satpx' WHERE id='$Pid0' ";
                $qupdetapa7 = $dbc->query($updetapa7);

                
                $updetapa5 = "UPDATE $cat_tarjetas_med SET satihosp='$sathosp' WHERE id='$Pid0' ";
                $qupdetapa5 = $dbc->query($updetapa5);
                ...
                $tabco = "INSERT INTO $hist_coment VALUES (NULL,'$Pregion0','$Punidad0','4','$Pid0',
                ...
                if($adminrol== $radmin ){
                    $tabsave1 = "INSERT INTO $tabtaskY VALUES (NULL,'$Pregion0','$Punidad0','ADMIN','ADMIN','$yerfinpro','4','$tarj_med',
                    '$fechahoy',NULL,'$userLog','$userLog','CONCILIACION','$accion','$nombreREsp',
                    '$fechapro','$yerfinpro','$mesfinpro','$diafinpro',NULL,'EN CURSO',
                    NULL,NULL,NULL,NULL,NULL,'$userLog','$userkaskLY','lead','SI' )";
                }else{
                    $tabsave1 = "INSERT INTO $tabtaskY VALUES (NULL,'$Pregion0','$Punidad0','$dirger','$userjefe','$yerfinpro','4','$tarj_med',
                    '$fechahoy',NULL,'$userLog','$userLog','CONCILIACION','$accion','$nombreREsp',
                    '$fechapro','$yerfinpro','$mesfinpro','$diafinpro',NULL,'EN CURSO',
                    NULL,NULL,NULL,NULL,NULL,'$userLog','$userkaskLY','lead','SI' )";
                }
