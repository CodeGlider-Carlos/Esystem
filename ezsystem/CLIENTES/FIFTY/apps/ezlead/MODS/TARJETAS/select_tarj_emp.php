        ...
        <section id="section1a" class="sectionmod">
            ...
            <datalist id="person">
                ...
                <?php
                    ...
                    if($adminrol== $radmin ){
                        $bdpros= "SELECT * FROM $crm_prosE ";
                        $qbdpros = $dbc->query($bdpros);
                    }elseif($adminrol== $radmin ){
                        $bdpros= "SELECT * FROM $crm_prosE WHERE region LIKE '%$userAcroregion%' ";
                        $qbdpros = $dbc->query($bdpros);
                    }else{
                        $bdpros= "SELECT * FROM $crm_prosE WHERE useresp LIKE '%$userLog%' ";
                        $qbdpros = $dbc->query($bdpros);
                    }
            ...
            <form class="tabcposELECT" method="POST"  action="tarjetas_emp.php" autocomplete="off" onkeydown="return event.key != 'Enter';" >
