...
<body>
    ...
    <modseg  id="modprosp">
        ...
        <section id="section1a" class="sectionmod">
            ...
            <div class="namesect" id="namesect1">SELECCIONTAR TIPO</div>
            ...
            <form class="tabcposELECT" method="POST"  action="tipotarjea.php" autocomplete="off" onkeydown="return event.key != 'Enter';" >

                <div for="person" class="label">Tipo de Tarjeta</div>

                    <?php

                        if($adminrol = $radmin){
                            ?>
                                <select class="select" name="tipopro" required>

                                    <option value="" selected>...</option>
                                    <option value="EMPRESA" >RED</option>
