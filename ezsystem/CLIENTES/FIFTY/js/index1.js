...
$(document).ready(function () {
 ...
 ///////////////////////////////////////
    ...
    $('.backicon').mouseout(function () {
        ...
        $('#leadmas').mouseover(function () {
            setTimeout(() => {
                $('#textleadmas').css('display', 'block')
       
            }, 0)
        });
        $('#leadmas').mouseout(function () {
            setTimeout(() => {
                $('#textleadmas').css('display', 'none')
            }, 0)
        });
        ...
        $('#ezdocument').mouseout(function () {
         ...
         $('#ezlead').mouseover(function () {
            setTimeout(() => {
                $('#text_leadled').css('display', 'block')
       
            }, 0)
        });
        $('#ezlead').mouseout(function () {
            setTimeout(() => {
                $('#text_leadled').css('display', 'none')
            }, 0)
        });
